...
import com.qiyei.android.http.server.ProgressRequestBody;
...
//     * @return
//     */
//    public static <T> String buildGetRequestUrl(HttpRequest<T> request){
...
//     * @return
//     */
//    public static <T,R> Call buildUploadCall(OkHttpClient client, HttpTask<T> task, IHttpTransferCallback<T,R> callback){
//
//        String url = OkHttpHelper.buildPostRequestUrl(task.getRequest());
//
...
//    }
    ...
    public static <T> T parseJson(String json,Class<T> clazz){
        ...
        HttpLog.d(HTTP.TAG,"genType:" + genType.toString());
        //判断是不是参数化类型
        Type[] params = ((ParameterizedType) genType).getActualTypeArguments();
        HttpLog.d(HTTP.TAG,"params:" + params.toString());

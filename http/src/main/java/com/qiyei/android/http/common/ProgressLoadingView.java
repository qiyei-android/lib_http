...
public class ProgressLoadingView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width = dip2px(mContext,80);
        int height = dip2px(mContext,80);
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        //获取xml属性
        TypedArray array = mContext.obtainStyledAttributes(attrs, R.styleable.ProgressLoadingView);
        //默认为0.3透明灰色
        int defaultColor = 0x40888888;
        mBottomColor = array.getColor(R.styleable.ProgressLoadingView_bottom_color,defaultColor);
        //默认蓝色
        mTopColor = array.getColor(R.styleable.ProgressLoadingView_top_color,Color.BLUE);
        //默认 5dp
        mRingWidth = (int)array.getDimension(R.styleable.ProgressLoadingView_ring_width,
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,5,getResources().getDisplayMetrics()));
        //字体颜色
        mTextColor = array.getColor(R.styleable.ProgressLoadingView_text_color,Color.BLUE);
        //字体大小 18sp
        mTextSize = (int)array.getDimension(R.styleable.ProgressLoadingView_text_size,

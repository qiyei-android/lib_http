...
import static com.qiyei.android.http.ssl.SSLConstant.TAG;
...
public class SSLUtils {
    ...
    private static TrustManager[] prepareTrustManager(InputStream trustInput,String alias) {
        if (trustInput == null || alias == null){
            Log.e(TAG,"prepareTrustManager error trustInput or alias is null,trustInput = " + trustInput + " alias = " + alias);
            return null;
        }
        try {
            ...
            Log.i(TAG,"prepareTrustManager KeyStore.getDefaultType()=" + defaultType);
    ...
    private static KeyManager[] prepareKeyManager(InputStream keyInput, String password) {
        try {
            if (keyInput == null || password == null) {
                Log.i(TAG, "prepareKeyManager error, keyInput or password is null");
                return null;
            }
            ...
            Log.i(TAG, "prepareKeyManager success ");
